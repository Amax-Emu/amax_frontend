...
export default function PersonalPlayerProfile() {
    ...
    React.useEffect(() => {
        async function getServerData() {
            const resp = await fetch(AMAX_API_URL + "/players/name/" + user.userData.amax_player_data.stats.playerName, {
